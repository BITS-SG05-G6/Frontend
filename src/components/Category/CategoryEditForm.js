...
const CategoryEditForm = ({
  ...
  const onSubmit = async (d) => {
    console.log({ id, icon, color, name, amount, type });
    // await axiosInstance
    //   .createCategory(
    //     d.name,
    //     d.type,
  ...
  return (
    <>
      ...
      <div
        onClick={() =>
          document.getElementById(`edit_category_${id}`).showModal()
        }
      >
        {children}
      </div>

      <dialog id={`edit_category_${id}`} className="modal overflow-visible">
